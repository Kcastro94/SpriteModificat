...
class Game {
    private static final int RAW1 = 0;
    private static final int RAW2 = 1;
    ...
    Game(Activity activity) {
        ...
        bitmapSet = new BitmapSet(context.getResources(), RAW1);
        bitmapSet2 = new BitmapSet(context.getResources(), RAW2);
    ...
    BitmapSet getBitmapSet2() {return bitmapSet2; }
    ...
    void addEnemy2(Enemy2 enemy2) {enemies2.add(enemy2);}
